...
.svd-toolbar-dropdown{line-height:34px;margin-right:1em;white-space:nowrap}.svd-toolbar-dropdown .svd-toolbar-dropdown__label{display:inline-block;vertical-align:top}.svd-toolbar-dropdown .svd-toolbar-dropdown__select{display:inline-block;padding:6px 12px;border:1px solid #ccc;height:34px;min-width:100px}.svd_container .svd_content .svd-toolbar-dropdown .svd_custom_select{vertical-align:top;width:auto}.svd_container .svd_content .svd-toolbar-dropdown .svd_custom_select .svd-toolbar-dropdown__select{padding-top:0;padding-bottom:0;padding-left:12px;padding-right:40px}
...
svd-splitter{display:table-cell;min-width:4px;width:4px;max-width:4px;cursor:ew-resize;position:relative}svd-splitter div.svd-splitter{background-color:lightgray;position:absolute;top:0;left:0;right:0;bottom:0}svd-splitter:hover>div.svd-splitter.svd-splitter.svd-splitter,svd-splitter.svd-active-splitter>div.svd-splitter.svd-splitter.svd-splitter{background-color:gray}svd-splitter:hover>div.svd-splitter.svd-splitter.svd-splitter>div.icon-split>svg.svd-svg-icon,svd-splitter.svd-active-splitter>div.svd-splitter.svd-splitter.svd-splitter>div.icon-split>svg.svd-svg-icon{fill:gray}svd-splitter>div.svd-splitter.svd-splitter.svd-splitter>div.icon-split{position:absolute;top:50%;left:-6px}svd-splitter>div.svd-splitter.svd-splitter.svd-splitter>div.icon-split>svg.svd-svg-icon{width:16px;height:16px;fill:lightgray}
