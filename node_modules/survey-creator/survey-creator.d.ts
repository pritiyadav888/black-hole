/*Type definitions for SurveyJS Creator JavaScript library v1.8.36
...
export declare class PropertyEditorNestedItemViewModel {
    ...
    obj: any;
    koHasDetails: any;
    constructor(editor: any, model: SurveyNestedPropertyEditorItem, koCanDeleteItem: ko.Observable<boolean>, dragIcon: string, deleteIcon: string, obj: any, koHasDetails: any);
...
export declare class CreatorBase<T extends {
        ...
        protected updateConditionsOnRemove(name: string): void;
        selectElement(element: any): void;
